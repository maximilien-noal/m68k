namespace M68k.CPU.Instructions
{
    public class NEG : IInstructionHandler
    {
        ...
        protected virtual uint Neg_byte(uint opcode)
        {
        ...
        protected virtual uint Neg_word(uint opcode)
        {
        ...
        protected virtual uint Neg_long(uint opcode)
        {
