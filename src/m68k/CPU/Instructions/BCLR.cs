...
namespace M68k.CPU.Instructions
{
    public class BCLR : IInstructionHandler
    {
        ...
        protected int BclrDynByte(int opcode)
        {
        ...
        protected int BclrDynLong(int opcode)
        {
        ...
        protected int BclrStaticByte(int opcode)
        {
        ...
        protected int BclrStaticLong(int opcode)
        {
        ...
        private sealed class AnonymousInstruction : IInstruction
        {
            ...
            {
                return parent.BclrDynLong(opcode);
            }
        }
        ...
        private sealed class AnonymousInstruction1 : IInstruction
        {
            ...
            public int Execute(int opcode)
            {
                return parent.BclrDynByte(opcode);
            }
        }
        ...
        private sealed class AnonymousInstruction2 : IInstruction
        {
            ...
            public int Execute(int opcode)
            {
                return parent.BclrStaticLong(opcode);
            }
        }
        ...
        private sealed class AnonymousInstruction3 : IInstruction
        {
            ...
            public int Execute(int opcode)
            {
                return parent.BclrStaticByte(opcode);
            }
        }
    }
}