...
{
    public class ADDITest : BasicSetup
    {
        public ADDITest() : base()
        {
        }
        ...
        {
            SetInstructionParamW(0x0600, 0x0078);
        ...
        {
            SetInstructionParamL(0x0680, -126462926);
            model.CPU.SetDataRegister(0, 305419896);
            model.CPU.SetCCR((byte)0x1f);
            _ = model.CPU.Execute();
        ...
        {
            SetInstructionParamW(0x0640, 0xaa78);
            model.CPU.SetDataRegister(0, 305419896);
            model.CPU.SetCCR((byte)0x1f);
            _ = model.CPU.Execute();
